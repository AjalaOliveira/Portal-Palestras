...
using Palestras.Infra.CrossCutting.Identity.Models.ManageViewModels;
...
namespace Palestras.UI.Site.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            if (model.Email != email)
            {
                ...
                if (!setEmailResult.Succeeded)
                    throw new ApplicationException(
                        $"Ocorreu um erro inesperado ao configurar o email para o usuário com o ID '{user.Id}'.");
            }
            ...
            if (model.PhoneNumber != phoneNumber)
            {
                ...
                if (!setPhoneResult.Succeeded)
                    throw new ApplicationException(
                        $"Ocorreu um erro inesperado ao definir o número de telefone do usuário com o ID '{user.Id}'.");
            }
        ...
        public async Task<IActionResult> LinkLoginCallback()
        {
            ...
            if (info == null)
                throw new ApplicationException(
                    $"Ocorreu um erro inesperado ao carregar informações de login externas para o usuário com ID '{user.Id}'.");

            var result = await _userManager.AddLoginAsync(user, info);
            if (!result.Succeeded)
                throw new ApplicationException(
                    $"Ocorreu um erro inesperado ao adicionar login externo para usuário com ID '{user.Id}'.");
        ...
        public async Task<IActionResult> Disable2faWarning()
        {
            ...
            if (!user.TwoFactorEnabled)
                throw new ApplicationException(
                    $"Ocorreu um erro inesperado ao desativar 2FA para usuário com ID '{user.Id}'.");
        ...
        public async Task<IActionResult> Disable2fa()
        {
            ...
            _logger.LogInformation("Usuário com ID {UserId} desabilitou 2FA.", user.Id);
        ...
        public async Task<IActionResult> ResetAuthenticator()
        {
            ...
            await _userManager.ResetAuthenticatorKeyAsync(user);
            _logger.LogInformation("O usuário com o ID '{UserId}' redefiniu a chave do aplicativo de autenticação.",
                user.Id);
        ...
        public async Task<IActionResult> GenerateRecoveryCodes()
        {
            ...
            if (!user.TwoFactorEnabled)
                throw new ApplicationException(
                    $"Não é possível gerar códigos de recuperação para o usuário com o ID '{user.Id}', pois eles não têm 2FA ativado.");
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Palestras Project"),
